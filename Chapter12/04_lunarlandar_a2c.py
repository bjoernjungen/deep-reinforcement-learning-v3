...
if __name__ == "__main__":
    ...
    #writer = SummaryWriter(comment="-lunarlandar-a2c_" + args.name)
    writer = SummaryWriter(comment="-lunarlandar-a2c_" )

    net = A2C.A2C(env.single_observation_space.shape[0],
    ...
    with A2C.RewardTracker(writer, stop_reward=190) as tracker:
        with TBMeanTracker(writer, batch_size=10) as tb_tracker:
            for step_idx, exp in enumerate(exp_source):
                ...
                states_t, actions_t, vals_ref_t = A2C.unpack_batch(
